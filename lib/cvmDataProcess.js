...
const main = async () => {
    try {
        ...
        try {
            ...
            dataList.push({ url: fbcdata_sgs_11i, metadata: fbcdata_sgs_11i_metadata });
            dataList.push({ url: fbcdata_sgs_7i, metadata: fbcdata_sgs_7i_metadata });
            dataList.push({ url: fbcdata_sgs_433i, metadata: fbcdata_sgs_433i_metadata });
            dataList.push({ url: fbcdata_sgs_189i, metadata: fbcdata_sgs_189i_metadata });
            dataList.push({ url: fbcdata_sgs_190i, metadata: fbcdata_sgs_190i_metadata });
            dataList.push({ url: fbcdata_sgs_1i, metadata: fbcdata_sgs_1i_metadata });
            dataList.push({ url: fbcdata_sgs_21619i, metadata: fbcdata_sgs_21619i_metadata });
