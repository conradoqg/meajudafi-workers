...
class ProgressReporter {
    ...
    outputs = [];
    pretty = null;
    constructor(progressTracker, reportInterval = 2000, pretty = true) {
                ...
                if (this.pretty) {
                    pretty = {
                        ...
                        state: {
                            ...
                            total: this.progressTracker.state.total == null ? 'unknown' : this.progressTracker.state.total,
                            ...
                            current: this.progressTracker.state.current == null ? 'unknown' : this.progressTracker.state.current,
                            percentage: this.progressTracker.state.percentage == null ? 'unknown' : this.progressTracker.state.percentage.toFixed(2),
                            ...
                            speed: this.progressTracker.state.speed == null ? 'unknown' : this.progressTracker.state.speed.toFixed(2)
                        }
                    };
                }
