...
DROP VIEW inf_cadastral_fi_with_xpi_and_iryf_of_last_year_max_min;
...
const inf_cadastral_fi_with_xpi_and_iryf_of_last_year_max_min = `
CREATE OR REPLACE VIEW inf_cadastral_fi_with_xpi_and_iryf_of_last_year_max_min
AS
SELECT COUNT(1), MAX(iry_investment_return_1y) as iry_investment_return_1y_max, MIN(iry_investment_return_1y) as iry_investment_return_1y_min FROM inf_cadastral_fi_with_xpi_and_iryf_of_last_year WHERE iry_investment_return_1y <> 'Infinity'
`;
...
class Db {
    ...
    async migrate() {
        ...
        try {
            ...
            await client.query(inf_cadastral_fi_with_xpi_and_iryf_of_last_year_max_min);
        } catch (ex) {
            throw ex;
        } finally {
            client.release();
