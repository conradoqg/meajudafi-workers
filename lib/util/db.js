...
CREATE ROLE readonly WITH LOGIN ENCRYPTED PASSWORD '${CONFIG.READONLY_PASSWORD}' NOSUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION VALID UNTIL 'infinity';
...
DROP INDEX inf_cadastral_fi_with_xpi_and_iryf_of_last_year_f_unaccent_idx;
DROP FUNCTION icf_denom_social_unaccented;
