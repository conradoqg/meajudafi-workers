...
const createCalculatorStream = (startSavingFrom) => {
    ...
    startSavingFrom = `${startSavingFrom.$y}-${string.pad(startSavingFrom.$M + 1, 2)}-${string.pad(startSavingFrom.$D, 2)}`;
    ...
    const processDaily = (stream, chunk, chunkBefore) => {
        ...
        if (ird_dt_comptc >= startSavingFrom) {
            stream.push({
    ...
    const processMonthly = (stream, chunk) => {
        ...
        if (risk) {
            ...
            if (irm_dt_comptc >= startSavingFrom) {
                stream.push({
    ...
    const processYearly = (stream, chunk) => {
        ...
        if (risk) {
            ...
            if (iry_dt_comptc >= startSavingFrom) {
                stream.push({
