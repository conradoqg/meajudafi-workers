...
const createCalculatorStream = () => {
    ...
    const processDaily = (stream, chunk, chunkBefore) => {
        ...
        if (chunkBefore) {
            ...
            ird_igpm_investment_return_mtd = returnFromQuota(chunksByYearAndMonth[year][month][0].igmp_quota, chunk.igmp_quota);
            ...
            ird_igpm_investment_return_ytd = returnFromQuota(chunksByYear[year][0].igmp_quota, chunk.igmp_quota);
            ...
            ird_igpm_investment_return_1m = returnFromQuota(last21Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            ird_igpm_investment_return_3m = returnFromQuota(last63Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            ird_igpm_investment_return_6m = returnFromQuota(last126Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            ird_igpm_investment_return_1y = returnFromQuota(last252Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            ird_igpm_investment_return_2y = returnFromQuota(last504Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            ird_igpm_investment_return_3y = returnFromQuota(last756Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            ird_igpm_accumulated_investment_return = returnFromQuota(chunks[0].igmp_quota, chunk.igmp_quota);
    ...
    const processMonthly = (stream, chunk) => {
        ...
        if (risk) {
            ...
            const irm_igpm_investment_return_mtd = returnFromQuota(chunksByYearAndMonth[year][month][0].igmp_quota, chunk.igmp_quota);
            ...
            const irm_igpm_investment_return_ytd = returnFromQuota(chunksByYear[year][0].igmp_quota, chunk.igmp_quota);
            ...
            const irm_igpm_investment_return_1m = returnFromQuota(last21Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const irm_igpm_investment_return_3m = returnFromQuota(last63Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const irm_igpm_investment_return_6m = returnFromQuota(last126Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const irm_igpm_investment_return_1y = returnFromQuota(last252Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const irm_igpm_investment_return_2y = returnFromQuota(last504Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const irm_igpm_investment_return_3y = returnFromQuota(last756Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const irm_igpm_accumulated_investment_return = returnFromQuota(chunks[0].igmp_quota, chunk.igmp_quota);
    ...
    const processYearly = (stream, chunk) => {
        ...
        if (risk) {
            ...
            const iry_igpm_investment_return_ytd = returnFromQuota(chunksByYear[year][0].igmp_quota, chunk.igmp_quota);
            ...
            const iry_igpm_investment_return_1m = returnFromQuota(last21Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const iry_igpm_investment_return_3m = returnFromQuota(last63Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const iry_igpm_investment_return_6m = returnFromQuota(last126Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const iry_igpm_investment_return_1y = returnFromQuota(last252Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const iry_igpm_investment_return_2y = returnFromQuota(last504Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const iry_igpm_investment_return_3y = returnFromQuota(last756Chunks[0].igmp_quota, chunk.igmp_quota);
            ...
            const iry_igpm_accumulated_investment_return = returnFromQuota(chunks[0].igmp_quota, chunk.igmp_quota);
