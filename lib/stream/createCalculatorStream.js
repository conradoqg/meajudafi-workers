...
const createCalculatorStream = () => {
    ...
    const processDaily = (stream, chunk, chunkBefore) => {
        ...
        if (chunkBefore) {
            ...
            bovespa_investment_return = bovespaChange;
            ...
            bovespa_investment_return_1y = returnFromQuota(last252Chunks[0].bovespa_valor, chunk.bovespa_valor);
            ...
            bovespa_investment_return_2y = returnFromQuota(last504Chunks[0].bovespa_valor, chunk.bovespa_valor);
            ...
            bovespa_investment_return_3y = returnFromQuota(last756Chunks[0].bovespa_valor, chunk.bovespa_valor);
            ...
            bovespa_accumulated_investment_return = returnFromQuota(chunks[0].bovespa_valor, chunk.bovespa_valor);
        ...
        stream.push({
            ...
            fields: {
                ...
                bovespa_investment_return,
                bovespa_investment_return_1y,
                bovespa_investment_return_2y,
                bovespa_investment_return_3y,
                bovespa_accumulated_investment_return
            }
        });
    };
    ...
    const processMonthly = (stream, chunk) => {
        ...
        if (risk) {
            ...
            const bovespa_investment_return = returnFromQuota(lastMonthOrFirstDay(chunk, year, month, lastYear, lastMonth).bovespa_valor, chunk.bovespa_valor);
            ...
            const bovespa_investment_return_1y = returnFromQuota(last252Chunks[0].bovespa_valor, chunk.bovespa_valor);
            ...
            const bovespa_investment_return_2y = returnFromQuota(last504Chunks[0].bovespa_valor, chunk.bovespa_valor);
            ...
            const bovespa_investment_return_3y = returnFromQuota(last756Chunks[0].bovespa_valor, chunk.bovespa_valor);
            ...
            const bovespa_accumulated_investment_return = returnFromQuota(chunks[0].bovespa_valor, chunk.bovespa_valor);
    ...
    const processYearly = (stream, chunk) => {
        ...
        if (risk) {
            ...
            const bovespa_investment_return = returnFromQuota(lastYearOrFirstDay(chunk, year, lastYear).bovespa_valor, chunk.bovespa_valor);
