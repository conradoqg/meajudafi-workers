    ...
    const processDaily = (stream, chunk, chunkBefore) => {
        ...
        stream.push({
            ...
            fields: {
                ...
                ird_dt_comptc: `${chunk.dt_comptc.$y}-${pad(chunk.dt_comptc.$M + 1, 2)}-${pad(chunk.dt_comptc.$D, 2)}`,
        ...
        if (risk) {
            ...
            stream.push({
                ...
                fields: {
                    ...
                    irm_dt_comptc: `${enfOfMonth.$y}-${pad(enfOfMonth.$M + 1, 2)}-${pad(enfOfMonth.$D, 2)}`,
        ...
        if (risk) {
            ...
            stream.push({
                ...
                fields: {
                    ...
                    iry_dt_comptc: `${endOfYear.$y}-${pad(endOfYear.$M + 1, 2)}-${pad(endOfYear.$D, 2)}`,
...
const pad = function (string, size) {
    let s = String(string);
