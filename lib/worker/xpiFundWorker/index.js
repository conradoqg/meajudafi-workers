        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    let rowsToUpsert = discoverFunds(funds, xpiFunds, (progress) => ui.update('XPIFundWorkerProcessing', progress));
            ...
            console.error('Error: XPIFundWorker: work');
...
const getFundsData = async (pool, progressCallback) => {
    ...
    try {
        ...
        xpiFunds = await asyncPool(4, xpiFundObjectList, async item => {
            ...
            while (retriesLeft-- > 0) {
                try {
                    ...
                    console.error('Error: getFundsData 1');
                    console.error(ex.stack);
                    lastError = ex;
                }
            }
        ...
        console.error('Error: getFundsData 2');
        console.error(ex.stack);
    } finally {
        await browser.close();
    }
