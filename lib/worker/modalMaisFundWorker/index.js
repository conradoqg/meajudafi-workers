        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    let rowsToUpsert = discoverFunds(funds, modalMaisFunds, (progress) => ui.update('ModalMaisFundWorkerDataProcessing', progress));
            ...
            console.error('Error: ModalMaisFundWorker: work');
...
const discoverFunds = (funds, modalMaisFunds, progressCallback) => {
    ...
    modalMaisFunds.forEach(item => {
        ...
        else console.log(`Fund '${normalizedProduct}' id or cnpj is null, ignoring...`);
