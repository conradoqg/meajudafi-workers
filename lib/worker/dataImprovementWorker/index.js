        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    const queryfundsCount = await mainClient.query('SELECT cnpj_fundo, denom_social FROM inf_cadastral_fi');
                    ...
                    const createDataImprovementStream = () => stream.Transform({
                        ...
                        transform: async (chunk, e, callback) => {
                            try {
                                const normalizedFundName = chunk.denom_social
                                ...
                                console.log(`${chunk.denom_social} = ${normalizedFundName}`);
