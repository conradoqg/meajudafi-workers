        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    const queryfundsCount = await mainClient.query('SELECT cnpj_fundo, MIN(DT_COMPTC) as start FROM inf_diario_fi WHERE pending_statistic_at is not null GROUP BY cnpj_fundo');
                    //const queryfundsCount = await mainClient.query('SELECT cnpj_fundo FROM inf_diario_fi GROUP BY cnpj_fundo LIMIT 200');
                    //const queryfundsCount = await mainClient.query('SELECT cnpj_fundo FROM inf_diario_fi WHERE cnpj_fundo=\'17489031000150\' GROUP BY cnpj_fundo');
