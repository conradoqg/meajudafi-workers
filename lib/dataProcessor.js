    ...
    for (const data of dataList) {
        ...
        if (shouldDownload) {
            ...
            try {
                ...
                try {
                    ui.start(`download-${data.url}`, 'Downloading', createStreamProgressInfo(`Downloading ${data.name}`), createDownloadStreamFinishInfo(`Downloaded ${data.name}`));
                    ...
                    if (success) {
                        ...
                        ui.start(`read-${data.url}`, 'Transforming', createStreamProgressInfo(`Transforming ${data.name}`), createTransformStreamFinishInfo(`Transformed ${data.name}`));
