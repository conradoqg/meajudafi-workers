            ...
            try {
                ...
                try {
                    ...
                    if (success) {
                        ...
                        readProgressStream.on('progress', (progress) => {
                            console.log(`Reading file ${data.url}: ${progress.percentage.toFixed(2)}%, speed:${progress.speed.toFixed(2)} bytes/s`);
                        });
                        ...
                        throw new Error(`Unable to download url ${data.url} after ${CONFIG.downloadRetries} retries`);
                    }
                } finally {
