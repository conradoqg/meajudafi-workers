ALTER TABLE public.investment_return_daily
    ADD COLUMN bovespa_investment_return double precision,
    ADD COLUMN bovespa_investment_return_1y double precision,
    ADD COLUMN bovespa_investment_return_2y double precision,
    ADD COLUMN bovespa_investment_return_3y double precision,
    ADD COLUMN bovespa_accumulated_investment_return double precision;
