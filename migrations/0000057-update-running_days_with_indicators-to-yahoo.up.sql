...
SELECT 
	...
	yahoo_data.date as bovespa_data, yahoo_data.close as bovespa_valor,
...
FROM running_days
	...
	LEFT JOIN yahoo_data ON yahoo_data.SYMBOL = '^BVSP' AND running_days.DT_COMPTC = yahoo_data.DATE
